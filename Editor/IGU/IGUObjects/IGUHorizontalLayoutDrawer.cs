...
namespace Cobilas.Unity.Editor.Graphics.IGU {
    [CustomPropertyDrawer(typeof(IGUHorizontalLayout))]
    public class IGUHorizontalLayoutDrawer : CPropertyDrawer {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (temp == null) EditorGUI.LabelField(position, label);
                ...
                serialized.Update();
                IGUHorizontalLayout obj = serialized.targetObject as IGUHorizontalLayout;
