...
namespace Cobilas.Unity.Editor.Graphics.IGU {
    [CustomPropertyDrawer(typeof(IGUTextFieldObject), true)]
    public class IGUTextFieldObjectDrawer : CPropertyDrawer {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (temp == null) EditorGUI.LabelField(position, label);
                ...
                serialized.Update();
                IGUTextFieldObject obj = serialized.targetObject as IGUTextFieldObject;
                ...
                if (prop_foldout.boolValue) {
                    ...
                    --EditorGUI.indentLevel;
                    DrawBackground(position = MoveDown(position, pheight + BlankSpace), EditorGUI.GetPropertyHeight(prop_settings));
                    ++EditorGUI.indentLevel;
