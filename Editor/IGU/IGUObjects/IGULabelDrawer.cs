    ...
    public class IGULabelDrawer : CPropertyDrawer {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (temp == null) EditorGUI.LabelField(position, label);
                ...
                serialized.Update();
                IGULabel obj = serialized.targetObject as IGULabel;
                ...
                SerializedProperty prop_autoSize = serialized.FindProperty("autoSize");
                ...
                if (prop_foldout.boolValue) {
                    ...
                    DrawBackground(position = MoveDown(position, pheight + BlankSpace), SingleRowHeightWithBlankSpace * 3f +
                    ...
                    _ = EditorGUI.PropertyField(position = MoveDownWithBlankSpace(position), prop_autoSize, EditorGUIUtility.TrTempContent("Auto size"));
                    obj.RichText = EditorGUI.Toggle(position = MoveDownWithBlankSpace(position), EditorGUIUtility.TrTempContent("Rich text"), obj.RichText);
