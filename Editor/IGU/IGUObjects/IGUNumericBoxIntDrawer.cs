...
namespace Cobilas.Unity.Editor.Graphics.IGU {
    [CustomPropertyDrawer(typeof(IGUNumericBoxInt))]
    public class IGUNumericBoxIntDrawer : CPropertyDrawer {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (temp == null) EditorGUI.LabelField(position, label);
                ...
                serialized.Update();
                IGUNumericBoxInt obj = serialized.targetObject as IGUNumericBoxInt;
                ...
                if (prop_foldout.boolValue) {
                    ...
                    DrawBackground(position = MoveDown(position, pheight + BlankSpace), pheight = SingleRowHeightWithBlankSpace * 4f +
