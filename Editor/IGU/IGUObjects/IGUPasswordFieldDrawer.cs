...
namespace Cobilas.Unity.Editor.Graphics.IGU {
    [CustomPropertyDrawer(typeof(IGUPasswordField))]
    public class IGUPasswordFieldDrawer : CPropertyDrawer {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (temp == null) EditorGUI.LabelField(position, label);
                ...
                serialized.Update();
                IGUPasswordField obj = serialized.targetObject as IGUPasswordField;
                ...
                SerializedProperty prop_maskChar = serialized.FindProperty("maskChar");
                ...
                if (prop_foldout.boolValue) {
                    ...
                    ++EditorGUI.indentLevel;
                    Rect recttemp;
                    _ = EditorGUI.PropertyField(position, prop_maskChar, EditorGUIUtility.TrTempContent("Mask char"));
