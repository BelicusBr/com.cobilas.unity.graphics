...
namespace Cobilas.Unity.Editor.Graphics.IGU {
    [CustomPropertyDrawer(typeof(IGUHorizontalSlider))]
    [CustomPropertyDrawer(typeof(IGUVerticalSlider))]
    public class IGUSliderDrawer : CPropertyDrawer {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (temp == null) EditorGUI.LabelField(position, label);
                ...
                SerializedProperty prop_onModifiedScrollbar = serialized.FindProperty("onModifiedSlider");
                SerializedProperty prop_onModifiedScrollbarInt = serialized.FindProperty("onModifiedSliderInt");
